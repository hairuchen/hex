 ...
 **/
@Service
@ConditionalOnProperty(name = "project.configuration.login.isSingle", havingValue = "false", matchIfMissing = true)
public class MultiLoginServiceImpl extends AbstractLoginServiceImpl implements LoginService {
